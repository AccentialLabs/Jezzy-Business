...
<?php if ($this->Session->read('userLoggedType') != 2) { ?>
    <div class="col-md-6">
        ...
        <div class="col-md-12">
            <div class="row <?php if(!empty($checkouts1)){ echo "saleFinalize"; }else{ echo "saleFinalizeEmptyList"; }?> " >
			<span  class="<?php if(empty($checkouts1)){ echo "boxDashFinalizeEmptyList";} ?>">
                Compras finalizadas
			</span>
    ...
    <div class="col-md-3 text-center">
		...
		<div class="row heightSquare leftSquare darkBlue delivery">
            ...
            <div class="row heightSquare leftSquare darkBlue">
                <span class="verticalAlign box-dash">Crie uma<br/> Nova Oferta</span>
            </div>
