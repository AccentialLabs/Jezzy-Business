    ...
    <div class="modal-dialog modal-md" >
        <div class="modal-content" id="modelContent">
            ...
            <div class="col-md-4">
				...
				<input type="number" name="rate_per_company_product" id="rate_per_company_product" class="form-control"/>
			</div>
            <div class="col-md-4">
				<label id=""><small>Comissão por Produto Jezzy (%)</small></label>
				<input type="number" class="form-control" name="rate_per_jezzy_product" id="rate_per_jezzy_product" />
			</div>
			<div class="col-md-4">
				<label id=""><small>Comissão por Serviço realizado (%)</small></label>
				<input type="number" class="form-control" name="rate_per_service" id="rate_per_service" />
			</div>
          </div>
		  <div>
