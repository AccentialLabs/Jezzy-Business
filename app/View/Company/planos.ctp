				  ...
				  <form role="form">
					<div class="form-group">
					 ...
					 <div class="item-plano pull-left" >
					  ...
					  <div class="item-plano pull-left plano-trial">
					  <div class="plano-header" >
							<h4>TRIAL</h4>
						</div>
							<div class="almost-jumbotron">
							<ul>
								<li>15 dias de Trial</li>
							</ul>
						</div>
						<div class="plano-valor" >
							<h4>R$00,00 <small class="plano-small"></small></h4>
						</div>
						<div class="text-center">
							<input type="radio" class="form-control"  id="myPlane" name="myPlane" value="TRIAL"/>
					  </div>
					  </div>
