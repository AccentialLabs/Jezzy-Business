						...
						*/
						if($newOffer == true){
							...
							if(!empty($selectedServiceId)){
								...
								/*$selectService = "select * from services where subclasse_id = {$selectedServiceId} and companie_id = {$company['Company']['id']};";
								$selServiceParam = array('User' => array('query' => $selectService));
								$servic = $this->AccentialApi->urlRequestToGetData('users', 'query', $selServiceParam);*/
