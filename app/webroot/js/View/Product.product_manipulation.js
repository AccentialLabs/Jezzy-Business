...
$(document).ready(function() {
	...
	$("#services-select").change(function(){
		...
		var historySelectList = ("select#services-select");
		var selectedValue = $('option:selected', historySelectList).attr("name");
		var valuesFromName = selectedValue.split("-");
		$("#selectedServiceId").val(valuesFromName[1]);
		$("#OfferTitle").val(valuesFromName[0]);
